            ...
            if(e.getActionCommand().equals("Search")){
                if(searchtext.getText().isEmpty() == false){
                  StudentRead  stdread = new StudentRead();
                    stdread.openFile();
                    boolean ans = stdread.readRecord(searchtext.getText());
                   
                    if(ans){
                        //JOptionPane.showMessageDialog(null,"Record Found of Student "+searchtext.getText(),"Information",1);
                        setVisible(false);
                        
                        
                    }else
                        JOptionPane.showMessageDialog(null,"Record Not Found of Student "+searchtext.getText(),"Error",0);
                    stdread.closeFile();
                }else{
                    JOptionPane.showMessageDialog(null, "Plaesa Enter Name to Search","Error",0);
                }
            }
